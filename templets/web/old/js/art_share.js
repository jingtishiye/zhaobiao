...
document.writeln("<script type=\"text/javascript\" src=\"/templets/web/js/art_web20.js\" charset=utf-8></script> <!--web2.0模块JS-->");

document.writeln("<style type=\"text/css\">@import url(/templets/web/style/share.css);</style><!--分享模块CSS文件-->");
